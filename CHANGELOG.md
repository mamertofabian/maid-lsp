...
### Changed
- Bump maid-runner dependency from >=2.0.0 to >=2.1.1
...
[Unreleased]: https://github.com/mamertofabian/maid-lsp/compare/v0.2.1...HEAD
[0.2.1]: https://github.com/mamertofabian/maid-lsp/compare/v0.2.0...v0.2.1
